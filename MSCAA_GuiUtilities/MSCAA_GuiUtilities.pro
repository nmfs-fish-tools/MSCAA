...
SOURCES += \
    VerboseDebugLevelDialog.cpp \
    nmfMSCAATableIO.cpp

HEADERS += \
    VerboseDebugLevelDialog.h \
    mainpage.h \
    nmfMSCAATableIO.h
